...
Route::get('payments/telr/checkout', 'TelrController@checkout');
Route::get('payments/telr/pay-success/{userId}/{amount}', 'TelrController@paySuccess');
Route::get('payments/telr/{amount}/{userId}', 'TelrController@index');
