...
// Route::get('/telr', function () {
//     redirect('/form/app-appointment.php');
// });

// Route::redirect('/telr', '/form/app-appointment.php?name='.$_GET['name']);
Route::redirect('/telr', '/form/app-appointment.php');
...
Route::get('bookings/cancel', 'API\BookingAPIController@cancel')->name('bookings.cancel');
