  ...
  <div class="boxed">
            ...
            <div id="content-container">
                 <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Outbound Calls Report</h1>
                    </div>
                    ...
                    <table id="all_calls_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        $current_month = $dateArray[month];
                          ...
                          $sql = mysqli_query($conn,"SELECT * FROM table_outbound_calls");
...
<script type="text/javascript">
    $(document).ready(function() {
       $('#all_calls_table').DataTable({
            ...
            buttons: [{
                  extend: 'excel',
                  title: 'Inbound Call Report - <?php echo $today_date ?> - Telesales Dashboard',
