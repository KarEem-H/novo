...
$job_sheet_id    = $_REQUEST['job_sheet_id'];
...
$technician      = mysqli_real_escape_string($conn,$_REQUEST['technician']);
...
$job_to_do       = mysqli_real_escape_string($conn,$_REQUEST['job_to_do']);
$spare_parts     = mysqli_real_escape_string($conn,$_REQUEST['spare_parts']);
$tools_required  = mysqli_real_escape_string($conn,$_REQUEST['tools_required']);
$agent_name      = $_SESSION['ADMIN_ID']['NAME'];
$agent_remarks   = $_REQUEST['agent_remarks'];

$sql = mysqli_query($conn,"UPDATE table_jobs SET `cust_name` = '$client_name',`cust_mobile` = '$client_mobile',`cust_email` = '$client_email',`cust_address` = '$client_address', `booking_date` = '$booking_date',`start_date` = '$start_date',`end_date` = '$end_date', `start_time` = '$start_time', `end_time` = '$end_time',`technician` = '$technician',`job_to_do` = '$job_to_do',`tools_required` = '$tools_required',`spare_parts` = '$spare_parts', `agent_name` = '$agent_name', `agent_remark` = '$agent_remarks', `job_amount` = '$job_amount' WHERE job_sheet_id = '$job_sheet_id'");

$sql1= mysqli_query($conn,"SELECT * FROM table_jobs WHERE job_sheet_id='$job_sheet_id'");
...
$row = mysqli_fetch_assoc($sql1);
    ...
    $remarks         = mysqli_real_escape_string($conn,$row['agent_remarks']);
    $agent_name      = $_SESSION['ADMIN_ID']['NAME'];
...
<table class="table table-bordered" style="width: 100%">
    ...
    echo "Job Sheet Edited Successfully!";
