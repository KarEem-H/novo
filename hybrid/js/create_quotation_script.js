    ...
    $('#submit').on('click',function(){
        ...
        if(client_name == "" || client_name == null || client_mobile == "" || client_mobile == null||  client_email == "" || client_email == null || client_address == "" || client_address == "<p><br></p>" || subject == "" || subject == null || service == "" || service == null || quotation_rate == "" || quotation_rate == null || payment_terms == "" || payment_terms == null || quotation_date == "" || quotation_date == null ){
            ...
            if(client_name == "")
                ...
                if(service == "")
                {
                    jQuery("#service").css({"border-color": "#e21b20", "border-width":"2px", "border-style":"double"});
                }
         ...
         $.ajax({
            type:"post",
            url: 'ajax/create_new_quotation.php',
            data:'client_name='+ client_name +'&client_mobile='+ client_mobile +'&client_email='+ client_email +'&client_address='+ client_address +'&subject='+ subject + '&service='+ description_array + '&scope_of_work='+ scope_of_work +'&quantity='+ quantity_array +'&quotation_date='+ quotation_date +'&quotation_rate='+ rate_array +'&payment_terms='+ payment_terms + '&price=' + price_total + '&inspection_id=' + inspection_id + '&maintenance_id=' + maintenance_id + '&sub_total=' + sub_total + '&vat=' + vat,           
                ...
                success: function(response) {
                        ...
                        $.niftyNoty({
                                ...
                                onHide:function(){
                                    ...
                                    if ($previous_url === 'https://higi.ae/hybrid/higi_maintenance_jobs.php') {
                                        window.location.href='higi_maintenance_jobs.php';
                                    }else{
