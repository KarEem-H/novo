  ...
  <div class="boxed">
            ...
            <div id="content-container">
                 <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Complaints Report</h1>
                    </div>
              ...
              <div class="panel">
                <div class="panel-body">
                  <div id="demo-custom-toolbar2" class="table-toolbar-left col-sm-12 col-md-12" style="padding: 18px;" width="100%">
                    ...
                    <table id="all_complaints_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      <thead>
                          <tr>
                              <th class="min-tablet">Id</th>
                              <th class="min-desktop">Complaint Date</th>
                              ...
                              <th class="min-desktop">Service Time</th>
                              ...
                              <th class="min-desktop">Agent Comments</th>
                          </tr>
                      </thead>
                      <tbody>
                        <?php

                          $sql = mysqli_query($conn,"SELECT * FROM table_complaints");
...
<script type="text/javascript">
    $(document).ready(function() {
       $('#all_complaints_table').DataTable({
            "scrollX": true,
            ...
            buttons: [{
                  extend: 'excel',
                  title: 'Complaints Report - <?php echo $today_date ?> - Telesales Dashboard',
       ...
       $.fn.dataTable.ext.search.push(
        function (settings, data, dataIndex) {
            ...
            var table = $('#all_complaints_table').DataTable();
