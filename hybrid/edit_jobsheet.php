...
if ($_REQUEST['jid']) {
    ...
    $agent_remarks      = $row1['agent_remark'];
                                        ...
                                        <div class="invoice_body_container">
                                            <div class="invoice-bill row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div style="padding: 5px 0 5px 0">
                                                                <div id="job_list" style="margin-left:22px;"><?php echo $job_to_do ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <h6><strong>ADDITIONAL COMMENTS:</strong></h6><br>
                                                            <div id="remarks" style="margin-left:22px;"><?php echo $agent_remarks ?></div>
                                                        </div>
                                            ...
                                            <div class="row pad-top pad-btm">
                                                <div class="col-sm-12 toolbar-center text-center">
                                                    ...
                                                    <button class="btn btn-primary" id="submit">Update Job Sheet</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).on('focus','#job_amount',function(){
        $(this).css({"border-color": "#e8ecec", "border-width":"1px", "border-style":"solid"});
    });
    ...
    var remarks         = escape($('#remarks').summernote('code'));


if(client_name == "" || client_name == null || client_mobile == "" || client_mobile == null||  client_email == "" || client_email == null || technician == "" || technician == null || job_amount == "" || job_amount == null){
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $.niftyNoty({
                type: 'success',
                container : 'floating',
                title : 'Jobsheet Updated',
                message : 'The Jobsheet has been Edited successfully!',
                closeBtn : true,
                timer : 500,
                onHide:function(){

                    window.location.href = 'job_sheet.php';
