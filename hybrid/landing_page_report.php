  ...
  <div class="boxed">
            ...
            <div id="content-container">
                 <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Landing Page Leads Report</h1>
                    </div>
                    ...
                    <ol class="breadcrumb">
  						...
  						<li class="active"><a href="landing_page_report.php">Landing Page Report</a></li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                </div>
              ...
              <div class="panel">
                <div class="panel-body">
                  <div id="demo-custom-toolbar2" class="table-toolbar-left col-sm-12 col-md-12" style="padding: 18px;" width="100%">
                    ...
                    <table id="all_leads_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      <thead>
                          <tr>
                              ...
                              <th class="min-desktop">Lead Status</th>
                          </tr>
                      </thead>
                      <tbody>
                        <?php

                          $sql = mysqli_query($conn,"SELECT id,created_date,cust_name,cust_mobile,cust_email,cust_region,cust_address,service_type,lead_status FROM `table_leads` WHERE cust_mobile!=''");
                          ...
                          while ($row = mysqli_fetch_array($sql, MYSQLI_ASSOC))
                            
                              {
                                  ...
                                  <tr>
                                      ...
                                      <td><?php echo $row['cust_region'] ?></td>
                                      <td style="width: 18%"><?php echo $row['cust_address'] ?></td>
...
<script type="text/javascript">
    $(document).ready(function() {
       $('#all_leads_table').DataTable({
            ...
            buttons: [{
                  extend: 'excel',
                  title: 'Landing Page Leads Report - <?php echo $today_date ?> - Telesales Dashboard',
       ...
       $.fn.dataTable.ext.search.push(
        ...
        var table = $('#all_leads_table').DataTable();
