...
if ($_SESSION['ADMIN_ID']['ID'] == "") {
    ...
    $admin_name = $_SESSION['ADMIN_ID']['NAME'];
}
                    ...
                    <table id="all_booking_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        $current_month = $dateArray[month];
                          ...
                          $sql = mysqli_query($conn,"SELECT t1.cust_id,t1.job_ref,t1.booking_date,t1.cleaning_date,t1.cleaning_time,t1.num_of_hours,t1.num_of_cleaners,t1.special_req,t1.service_type,t1.address,t1.area,t1.materials,t1.special_req,t1.agent_name,t1.total,t1.payment_status,t1.booking_status,t1.source,t1.call_type,t2.customer_name,t2.customer_mobile,t2.customer_email FROM (SELECT cust_id, job_ref,booking_date, cleaning_date,cleaning_time,num_of_hours,num_of_cleaners,service_type,address,area,materials,special_req,agent_name,total,payment_status,booking_status,source,call_type FROM table_booking WHERE booking_status !='Cancelled' AND agent_name='$agent_name') t1 LEFT JOIN (SELECT customer_id, customer_name, customer_mobile,customer_email FROM table_contacts) t2 ON (t1.cust_id = t2.customer_id)");
...
<script type="text/javascript">
    $(document).ready(function() {
       $('#all_booking_table').DataTable({
            ...
            buttons: [{
                  extend: 'excel',
                  title: '<?php echo $agent_name ?> - Booking Report - <?php echo $today_date ?> - Telesales Dashboard',
