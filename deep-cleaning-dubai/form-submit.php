...
$booking_ref          = 'HIGIMOVERS_'.$rndm_code;
...
$service_name         = "Movers and Packers";
...
// EMAIL SCRIPT
    ...
    $to = "abdul.wahab@higitech-me.com, shahzad@higitech-me.com, info@higitech-me.com, jen.castillo@higitech-me.com";

    $subject = "Booking from Deep Cleaning Services";
 ...
 //Confirmation page
    ...
    $userheaders = "From: HIGHTECH <info@higitech.me>\n";
...
<head>
    ...
    <title>Movers and Packers Dubai</title>
...
<script>
  gtag('event', 'conversion', {
      'send_to': 'AW-365884645/XZ9sCJ73-fUCEOXpu64B',
      'transaction_id': ''
  });
</script>
...
<body>
  ...
  <div class="icon icon--order-success svg">
	...
	<h3><span style="background-color: transparent; color: #ffffff">We have successfully received your booking. </span></h3><br>
  	...
  	<small style="font-size: 100%;color: #ffffff">One of our agent will call to confirm the schedule. If you have any queries you can reach us on 800 HME(463)</small>
...
$params = array(
        ...
        'ivp_desc'    => 'Moving and Packing Services',
        ...
        'return_auth' => 'https://movers-packers.higitech.me/landing/success.php',

        'return_can'  => 'https://movers-packers.higitech.me/landing/failed.php',

        'return_decl' => 'https://movers-packers.higitech.me/landing/failed.php'
