	jQuery(function ($) {
	    ...
	    $('input[name="dates"]').daterangepicker({
            ...
            if (date.day() == 0 || date.day() == 1 || date.day() == 2 || date.day() == 3 || date.day() == 4|| date.day() == 6)
              return false;
            return true;
          }
	    });
        ...
        var rate = 95;
        var rate_material = 300;
        var material_charges = (has_material ? rate_material * num_cleaners : 0);
        var subtotal = num_hours > 0 && num_cleaners > 0 ? (rate *  num_cleaners) : 0;
        var vat_rate = 0.05;
