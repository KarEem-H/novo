...
$service_name         = "Maintenance Services Dubai";
$source               = "Landing Page";
...
// EMAIL SCRIPT
    ...
    $subject = "Booking for Maintenance Services";
...
$params = array(
        ...
        'bill_country'  => 'AE',
        'bill_email'  => $email,
        'return_auth' => 'https://higitech.me/maintenance-services-dubai/success.php',
        'return_can'  => 'https://higitech.me/maintenance-services-dubai/failed.php',
        'return_decl' => 'https://higitech.me/maintenance-services-dubai/failed.php'
    );
