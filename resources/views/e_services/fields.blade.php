...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row ">
        <label class="col-md-3 control-label text-md-right mx-1">Time Slot</label>
        <div class="col-md-4">
            <input type="time" name="time_slot_start" class="form-control" id="time_slot_start" value="{!! $eService->time_slot_start ?? '' !!}">
            <div class="form-text text-muted">Insert Start Time</div>
        </div>
        <div class="col-md-4">
            <input type="time" name="time_slot_end" class="form-control" id="time_slot_end" value="{!! $eService->time_slot_end ?? '' !!}">
            <div class="form-text text-muted">Insert End Time</div>
        </div>
    </div>
    ...
    <!-- E Provider Id Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row " style="visibility: hidden;">
