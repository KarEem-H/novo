...
// echo $userId;
// die;
// {{{ Auth::booking()->username }}}
// dd($booking->getOriginal());
// die;
// session_start();
...
//     $mail = $_POST['email'];
//     $to = "abdul.wahab@higitech-me.com, shahzad@higitech-me.com, info@higitech-me.com, higisales2@higitech-me.com";
...
// $booking_id = $booking->getOriginal()['id'];
...
// die;
// $details = json_decode($booking_data->e_provider, true);
// $name = $details["name"];

// $address = json_decode($booking_data->address, true);
// $description = $address["description"];
// if(empty($description)){
//     $description = "Booking Payment";
// }
// $new_address = $address["address"];
// $user_id = $booking->getOriginal()['user_id'];
$params = array(
        'ivp_method'  => 'create',
        'ivp_store'   => '25698',
        ...
        'bill_fname'  => $name,
        'bill_sname'  => ' ',
        'bill_phone'  => $phone_number,
        // 'bill_addr1'  => $new_address,
        'bill_city'  => 'Dubai',
        'bill_country'  => 'AE',
        'bill_email'  => $email,
        'return_auth' => 'https://higitech.me/public/payments/telr/pay-success/'.$userId.'/'.$amount,
